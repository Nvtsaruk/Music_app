...
//        playlist = PlaylistModel(description: "", id: "", images: [ImageModel(url: "")], name: "", owner: PlaylistModelOwner(display_name: "", id: "", type: ""), tracks: PlaylistModelTracks(items: [PlaylistModelTracksItem(added_by: PlaylistModelTracksItemUser(id: "", type: ""), track: Track(album: TrackAlbum(album_type: "", artists: [TrackAlbumArtist(id: "", name: "", type: "")], id: "", images: [ImageModel(url: "")], name: "", release_date: "", type: ""), artists: [TrackAlbumArtist(id: "", name: "", type: "")], id: "", name: "", preview_url: "", type: ""))]), type: "")
        playlist = PlaylistModel(description: "", id: "", images: [ImageModel(url: "")], name: "",owner: PlaylistModelOwner(display_name: "", id: "", type: ""),tracks: PlaylistModelTracks(), type: "")
...
//            let playlistModelTracksItem = PlaylistModelTracksItem(added_by: playlistModelTracksItemUser, track: track)
